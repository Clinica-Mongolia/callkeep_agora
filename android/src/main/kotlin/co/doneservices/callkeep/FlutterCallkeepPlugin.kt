...
class FlutterCallkeepPlugin : FlutterPlugin, ActivityAware {
    companion object {
        @JvmStatic
        fun registerWith(registrar: PluginRegistry.Registrar) {
            val channel = MethodChannel(registrar.messenger(), "FlutterCallKeep.Method")
    ...
    override fun onAttachedToEngine(binding: FlutterPlugin.FlutterPluginBinding) {
        val channel = MethodChannel(binding.flutterEngine.dartExecutor, "FlutterCallKeep.Method")
        val event = MethodChannel(binding.flutterEngine.dartExecutor, "FlutterCallKeep.Event")
